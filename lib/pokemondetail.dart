            ...
            top:MediaQuery.of(context).size.height*0.1,
              ...
              child: Column(
                ...
                children: <Widget>[
                  ...
                  Row(
                    mainAxisAlignment: MainAxisAlignment.spaceEvenly,
                    children:pokemon.weaknesses.map((t)=>FilterChip(backgroundColor: Colors.pinkAccent, label:Text(t, style: TextStyle(color: Colors.white),),onSelected: (b){})).toList() ),
                
                  Text("Next Evoultion",style: TextStyle(fontWeight: FontWeight.bold), ),
                  Row(
                    mainAxisAlignment: MainAxisAlignment.spaceEvenly,
                    children:pokemon.nextEvolution.map((n)=>FilterChip(backgroundColor: Colors.green,label:Text(n.name,style: TextStyle(color: Colors.black)),onSelected: (b){})).toList() ),
